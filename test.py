...
class SkipGram:
    def __init__(self,sentences,nEmbed=100, minCount = 5):#winSize = 5
        vocabulary,word2idx,idx2word = vocab_ids(sentences,13000)
        id_pairs = create_pairs_pos_neg(sentences,word2idx,vocabulary,2,5,True,False)
        self.nEmbed = nEmbed
...
sentences = sent_train_clean[0:100]
